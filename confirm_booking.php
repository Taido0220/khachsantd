            ...
            <form action="pay_now.php" method="POST" id="booking_form">
              ...
              <div class="row">
               ...
               <!-- <div class="col-md-12 mb-3">
                  ...
                  <select class="form-select shadow-none" name="quantity_book">
                <?php 
              //   $room_q = mysqli_query($con,"SELECT quantity 
      ...
      if (checkin_val != '' && checkout_val != '') {
        ...
        xhr.onload = function() {
          ...
          if (data.status == 'check_in_out_equal') {
            ...
            pay_info.innerHTML = "Số Phòng Trống: " + data.c_rooms + "<br>Số ngày Đặt: " + data.days 
            + "<br>Tổng số tiền phải trả: " + data.payment + ' vnđ';
