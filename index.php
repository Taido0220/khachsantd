      ...
      <div class="col-lg-12 bg-white shadow p-4 rounded">
        ...
        <form action="rooms.php">
          <div class="row align-items-end">
            ...
            <label class="form-label" style="font-weight: 500;">Số lượng phòng</label>
            <select class="form-select shadow-none" name="quantity">
                <?php 
                $room_q = mysqli_query($con,"SELECT MAX(quantity) AS `max_quantity`
                FROM `rooms` WHERE `status`='1' AND `removed`='0'");  
              $room_res = mysqli_fetch_assoc($room_q);

                  for($i=1; $i<=$room_res['max_quantity']; $i++){
                    echo"<option value='$i'>$i</option>";
                  }
                ?>
              </select>
              ...
              <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                ...
                <div class="card-body">
                  ...
                  <div class="guests mb-4">
                    ...
                    <span class="badge rounded-pill bg-light text-dark text-wrap">
                     Số lượng phòng $room_data[quantity]
                    </span>
                  </div>
                  $rating_data
