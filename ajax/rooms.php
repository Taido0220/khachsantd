<?php 
  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    $quantity = ($guests['quantity']!='') ? $guests['quantity'] : 0;
    ...
    $room_res = select("SELECT * FROM `rooms` WHERE `adult`>=? AND `children`>=? AND  `quantity`>=?  AND `status`=? 
    AND `removed`=?",[$adults,$children,$quantity,1,0],'iiiii');
        ...
        <div class='card mb-4 border-0 shadow'>
          <div class='row g-0 p-3 align-items-center'>
            ...
            <div class='col-md-5 px-lg-3 px-md-3 px-0'>
              ...
              <div class='quantyti mb-3'>
              <h6 class='mb-1'>Số lượng</h6>
              $room_data[quantity] Phòng
            </div>
