        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <button type="button" class="btn custom-bg text-white shadow-none" data-bs-toggle="modal" data-bs-target="#feature-s">
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <button type="button" class="btn custom-bg text-white shadow-none" data-bs-toggle="modal" data-bs-target="#facility-s">
                <i class="bi bi-plus-square"></i> Thêm
              </button>
            </div>
      ...
      <form id="feature_s_form">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Thêm cơ sở vật chất Phòng</h5>
          </div>
