...
<body class="bg-light">
  ...
  <?php 
    ...
    if(isset($_GET['check_availability']))
    {
      ...
      $quantity_default = $frm_data['quantity'];
    }
  ?>
                ...
                <div class="d-flex">
                 <div class="mb-2">
                  ...
                  <div>
                    ...
                    <input type="number" min="1" id="quantity" value="<?php echo $quantity_default ?>" oninput="guests_filter()" class="form-control shadow-none">                 
                  </div>
  ...
  <script>
    ...
    function guests_filter(){
      if(adults.value>0 || children.value>0 || quantity.value>0){
        fetch_rooms();
